...
namespace RVS_REST_API.Controllers
{
    ...
    // Uloga klase: ProveraApiController grupiše podatke i/ili operacije koje pripadaju istoj funkcionalnoj celini.
    public class ProveraApiController : ControllerBase
    {
        ...
        [HttpGet("{korisnikId}")]
        // Proverava da li prosleđeni korisnik postoji i vraća rezultat provere pozivaocu.
