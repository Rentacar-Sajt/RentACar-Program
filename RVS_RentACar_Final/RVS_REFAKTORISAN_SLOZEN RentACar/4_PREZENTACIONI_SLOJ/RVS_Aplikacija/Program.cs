...
// Registracija Entity Framework DbContext-a: AppDbContext će koristiti isti DefaultConnection
// connection string kao ostatak aplikacije, pa EF radi nad istom RentACar bazom.
...
builder.Services.AddHttpClient("RestCrudServis", httpClient =>
{
    string adresa =
        ...
        ?? throw new InvalidOperationException(
            "Nije podeena adresa REST CRUD servisa."
        );
...
builder.Services.AddHttpClient("AutentikacijaServis", httpClient =>
{
    string adresa =
        ...
        ?? throw new InvalidOperationException(
            "Nije podeena adresa servisa za autentikaciju."
        );
