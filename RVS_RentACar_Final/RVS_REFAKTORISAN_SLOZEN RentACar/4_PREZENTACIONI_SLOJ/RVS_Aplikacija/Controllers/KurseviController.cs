...
{
    // Uloga klase: KurseviController grupiše podatke i/ili operacije koje pripadaju istoj funkcionalnoj celini.
    public class KurseviController : Controller
    {
        ...
        // Učitava podatke potrebne za listu kursa i prosleđuje ih Index prikazu.
        ...
        [HttpGet]
        // Otvara formu za dodavanje kursa i priprema početni model/podatke potrebne za prikaz forme.
        ...
        // Prima podatke iz forme za dodavanje kursa, proverava validaciju i šalje zahtev servisu da sačuva novi zapis.
        ...
        [HttpGet]
        // Učitava postojeće podatke kursa po ID-u i otvara formu za njihovu izmenu.
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        // Prima izmenjene podatke kursa, proverava validaciju i šalje zahtev servisu da ažurira zapis.
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        // Učitava podatke kursa koji treba obrisati i prikazuje stranicu za potvrdu brisanja.
        ...
        [HttpGet]
        // Učitava izabrani glavni zapis zajedno sa njegovim povezanim detail podacima i prosleđuje ih prikazu.
