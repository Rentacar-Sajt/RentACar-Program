...
if($_SERVER['REQUEST_METHOD']==='POST'){
 ...
 if(!$greska){try{$r=new IznajmljivanjeRepozitorijum();$id=$r->dodaj((int)$_SESSION['korisnik']['ID'],$od,$do,$izabrana);Sesija::postaviPoruku('Iznajmljivanje je uspešno kreirano.');header('Location: detalji.php?id='.$id.'&uspeh=1');exit;}catch(Throwable $e){$greska=$e->getMessage();}}
}
?>
