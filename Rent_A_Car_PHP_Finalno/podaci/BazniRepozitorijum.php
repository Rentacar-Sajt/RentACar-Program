...
// Zajednicki deo svih repozitorijuma. Ovde su pomocne metode za SQL upite.
require_once __DIR__ . '/BazaPodataka.php';

abstract class BazniRepozitorijum extends BazaPodataka
{
    // Ovu metodu koriste ostali repozitorijumi za SELECT upite.
    ...
    // Ova metoda je za INSERT, UPDATE i DELETE.
